...
// 	return (
// 		<div className="flex justify-center items-start gap-4 lg:gap-8 w-full py-1 lg:py-8 flex-col h-fit px-4 lg:px-0">
...
// 				) : (
// 					/* Upload Instructions */
// 					<div className="border h-full flex flex-col justify-between border-[#2FCAC7] rounded-2xl p-2 lg:p-5 text-gray-400 hover:border-blue-400 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/20 cursor-pointer">
...
// 								<HiSparkles
// 									size={32}
// 									className="text-[hsla(173,75%,52%,1)] lg:w-10 lg:h-10  hover:scale-110 hover:rotate-12 transition-all duration-300 flex-shrink-0"
// 								/>
// 								<div className="text-[hsla(173,75%,52%,1)] text-lg lg:text-3xl hover:text-white transition-colors duration-200">
...
// 									<div className="text-[hsla(173,75%,52%,1)] text-lg lg:text-3xl hover:text-white transition-colors duration-200">Choose File</div>
// 									<div className="text-xs lg:text-2xl">
// 										JPG / PNG Max. 10 MB
// 									</div>
// 								</div>
...
// 			{/* Right Section - Form */}
// 			<div className="flex flex-col justify-between w-full max-w-4xl lg:flex-1 lg:h-96 py-2 lg:py-3 h-fit gap-y-3 lg:gap-y-4">
...
// 						}
// 						maxLength={250}
// 						className="bg-transparent border rounded-lg px-3 py-2 lg:py-3 text-sm sm:text-base lg:text-lg text-white placeholder:text-gray-400 focus:outline-none border-[#2FCAC7] hover:border-blue-300 focus:border-blue-300 focus:shadow-lg focus:shadow-blue-400/20 transition-all duration-200 w-full"
// 						ref={titleRef}
// 					/>
// 				</div>
...
//                 <div className="flex flex-row justify-center lg:justify-evenly gap-3 lg:gap-4 w-full text-[24px]">
// 					<button
// 						onClick={handleUpload}
// 						disabled={isLocalUploading || isSavingDraft || !generatedImage}
// 						className={`rounded-2xl bg-[#28e0ca] px-4 py-1 w-full ${generatedImage ? 'sm:w-1/3' : 'sm:w-1/2'} lg:flex-1 lg:max-w-96 text-black font-semibold hover:bg-[#20c4aa] hover:scale-105 hover:shadow-lg hover:shadow-[#28e0ca]/30 transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed`}
// 					>
...
// 						className={`rounded-2xl border border-[#28e0ca] text-[#28e0ca] px-4 py-1 w-full ${generatedImage ? 'sm:w-1/3' : 'sm:w-1/2'} lg:flex-1 lg:max-w-96 flex items-center justify-center gap-2 font-semibold hover:bg-[#28e0ca] hover:text-black hover:scale-105 hover:shadow-lg hover:shadow-[#28e0ca]/30 transition-all duration-200 active:scale-95 group disabled:opacity-50 disabled:cursor-not-allowed`}
// 					>
