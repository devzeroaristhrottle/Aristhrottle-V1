...
export default function Page() {
  ...
  const TabButton = ({ label, isActive }: TabButtonProps) => (
    <button
      ...
      className={`text-xl md:text-4xl font-medium md:py-1 w-28 md:w-40 rounded-md transition-all duration-300 ${
  ...
  return (
    <div className="md:max-w-7xl mx-auto px-4 md:px-16 py-1 md:py-3">
      <div className="flex justify-between gap-4 md:gap-[2rem] border border-white rounded-10px md:max-w-5xl mx-2 md:mx-auto mb-2 md:mb-7 p-1 md:p-2">
